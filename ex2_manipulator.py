...
# we obtain camera configuration with print_camera_config = 1
cam.azimuth = 89.8 
cam.elevation = -89.0 
cam.distance =  5.318786674237309
...
##3 SET THE POSITIONS
"""
data.qpos[0] = 0 # joint 1 position
data.qpos[1] = 1.57 # joint 2 position # pi/2 =1.57 = 90 degree
"""

##4 SET THE RANGE AND STATING POINTS INSTEAD OF ##3
N = 500
q0_start = 0
q0_end = 1.57
q1_start = 1.57
